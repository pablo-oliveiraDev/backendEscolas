...
exports.CreatePresencaController = void 0;
const prismaClient_1 = require("../../database/prismaClient");
;
class CreatePresencaController {
    async handle(request, response) {
        var _a;
        const { tipoDePessoasId, presente, nomePessoa, cpf } = request.body;
        ...
        if (typeof idDadosPessoais !== null) {
            try {
                const presenca = await prismaClient_1.prismaClient.pessoaDadosEscolar.create({
                    data: {
                        presenca: {
                            create: {
                                presente: presente,
...
exports.CreatePresencaController = CreatePresencaController;
