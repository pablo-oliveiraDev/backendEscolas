...
describe('CreatePessoaDadosPessoaisController', () => {
    ...
    // Test that a new pessoaDadosPessoais is successfully created with endereco, dadosDocumentos, pagtoMes, and tipoDePessoa.
    it('should create a new pessoaDadosPessoais with endereco, dadosDocumentos, pagtoMes, and tipoDePessoa', async () => {
        ...
        prismaClient.endereco.create = jest.fn().mockResolvedValueOnce({
            pessoaDadosPessoais: {
                tipoDePessoa: {},
                dadosDocumentos: {},
                pagtoMes: {},
        ...
        const createPessoaDadosPessoaisController = new CreatePessoaDadosPessoaisController();

        // Act
        await createPessoaDadosPessoaisController.handle(request, response);

        // Assert
        expect(prismaClient.endereco.create).toHaveBeenCalledWith({
            data: {
